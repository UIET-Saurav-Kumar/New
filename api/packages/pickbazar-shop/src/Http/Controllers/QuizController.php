...
use PickBazar\Database\Repositories\QuizRepository;
...

{
    ...
    public function index(Request $request)
    {
        ...
        $quiz = $this->repository;
        return $quiz->paginate($limit);
    }
    ...
    {
        $request->id = $id;
        return $this->fetchSingleQuiz($request);
    }


    public function fetchSingleQuiz(Request $request)
    {
        $id = $request->id;
        try {
