...
const classes = {
  ...
  normal:
    "bg-magenta text-light border border-transparent hover:bg-gold",
  custom: "border border-transparent",
  outline:
    "border border-border-400 bg-transparent text-body hover:text-light hover:bg-accent hover:border-gold",
  loading:
