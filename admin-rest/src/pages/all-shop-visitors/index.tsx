...
import AllShopVisitorList from "@components/all-shop-visitors/all-shop-visitor-list";

export default function AllShopVisitors() {
...
AllShopVisitors.authenticate = {
    permissions: adminOnly,
};

AllShopVisitors.Layout = Layout;
