              ...
              { isLoading && !data?.pages?.length ? (
                ...
                <>
                    {data?.pages?.map((page, idx) => {
                          ...
                          return (
                            <div className={` ${query.text_type == 'shop' || query.text_type == 'Category'  || query.text_type == 'Shop_Category' ? 'grid grid-cols-2 place-items-center gap-1 lg:gap-4 px-2 lg:px-5 mt-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 w-full' : 'flex flex-col'}`} key={idx}>
