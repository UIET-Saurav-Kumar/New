...
export default function WebShopBanner() {
    ...
    return (
        ...
        <div  className='no-scrollbar flex justify-between space-x-2 w-full h-34   mt-2  overflow-x-scroll'>

            <div className=' flex justify-center items-center rounded-lg px-2 w-full h-28 lg:h-36 xl:h-42 bg-red-500 '>
            ...
            <div className=' flex justify-center items-center rounded-lg px-2 w-full h-28 lg:h-36 xl:h-42 bg-yellow-500 '>
            ...
            <div className=' flex justify-center items-center rounded-lg px-2 w-full h-28 lg:h-36 xl:h-42 bg-green-500 '>
