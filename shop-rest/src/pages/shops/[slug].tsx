...
const imageCheck = (logo: any , record:any, imgsize:any, imgDim:any, classname: string) => {
  ...
  return (check ?    < Image priority={true}     loading='eager' quality='40' src={logo} alt={record?.name}  width={1500} height={200} className={classname} />:<Avatar name={record?.name} size={imgsize} round={imgDim}  />);
}
                                    ...
                                    <div className='w-4/5 h-full'>
                                      {  cover_image?.length > 1 ?
                                       ...
                                       <div className=" w-full h-full"> 
                                          ...
                                          : 
                                          shopCat?.includes('Cosmetics') &&     < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_cosmetics.jpg'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Groceries') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_groceries.jpg'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Salon & Spa') &&     < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_salon.webp'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Vegetables & Fruits') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_fruits.jpg'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Pharmacy') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_pharmacy.jpg'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Fashion Lifestyle') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_fashion.webp'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Electronics') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_electronics.jpg'}   className='object-fill h-full w-full' /> ||
                                          shopCat?.includes('Health Products') &&    < Image priority={true}     loading='eager' quality='40' layout="intrinsic" width={1457} height={314} src={'/shop_cover_images/coverimage_cosmetics'}   className='object-fill h-full w-full' /> 
