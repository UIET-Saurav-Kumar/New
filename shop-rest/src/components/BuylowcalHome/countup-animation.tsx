                    ...
                    <ReactVisibilitySensor 
                        ...
                        delayedCall  >
                            <span className='flex text-2xl md:text-3xl lg:text-4xl lg:items-center'>   
                                <CountUp start={0} end={countUp ? 5000 : 0} duration={1} >
       ...
       <div className='flex flex-col  items-center'>
            ...
            <h1 className='text-2xl lg:text-4xl font-md'>
                    <ReactVisibilitySensor 
                        ...
                        delayedCall  >
                        <span className='flex text-2xl md:text-3xl lg:text-4xl lg:items-center'>   
                            <CountUp start={0} end={countUp ? 100000 : 0} duration={1} >
            ...
            <h1 className='text-2xl lg:text-4xl font-md'>
                ...
                <ReactVisibilitySensor 
                            ...
                            <span className='flex text-3xl md:text-3xl lg:text-4xl lg:items-center'>   
                                <CountUp start={0} end={countUp ? 12500000 : 0} duration={1} >
        ...
        <div className='flex flex-col  items-center'>
            ...
            <h1 className='text-2xl lg:text-4xl font-md'>
                ...
                <ReactVisibilitySensor 
                        ...
                        <span className='flex text-3xl md:text-3xl lg:text-4xl lg:items-center'>   
                            <CountUp start={0} end={countUp ? 25000000 : 0} duration={1} >
