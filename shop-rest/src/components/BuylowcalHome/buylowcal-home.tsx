    ...
    return (
        ...
        <div className=' flex flex-col bg-gray-100 bg-opacity-50 mx-0 px-0' >
             ...
             <div className='  w-full flex shadow-xl justify-between items-center  h-20 bg-gray-100 text-white top-0 '>
               ...
               <div className='relative h-96  bg-black z-100'> 
                    
                    <img 
                        src='/banner6.jpeg'
                        // src='https://image.shutterstock.com/image-photo/healthy-food-background-vegan-vegetarian-260nw-1696032517.jpg'
                        // src='https://thumbs.dreamstime.com/b/banner-different-groceries-food-donations-green-background-copyspace-pasta-fresh-vegatables-canned-cooking-oil-tomatoes-202878097.jpg'
                        // src='https://img.cdn4dd.com/cdn-cgi/image/fit=cover,width=1200,format=jpeg,quality=60/https://cdn.doordash.com/media/consumer/home/landing/hero/food/desktop_food.png' 
                        className=' opacity-40 h-full w-full object-cover  bg-black ' /> 
               </div>



                <div className= 'flex flex-col justify-center rounded p-6 shadow-5xl  w-1/2 lg:w-2/4  items-center 
                                 text-white absolute space-y-4 z-1 top-28  bg-transparent  right-16 opacity-90  lg:right-30' >

                    <h1 className='font-bold text-2xl xs+:text-3xl md:text-4xl  lg:text-5xl flex w-96 sm:w-96 lg:w-96  -mb-10 justify-center '> 
                                     Shop, Save and Earn
                    </h1>

                        <div className='   mt-10 text-black  w-11/12 ' >
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-3  lg:grid-cols-3  w-full  items-center lg:w-10/12 space-y-20    mt-10  lg:justify-around mx-auto ' >
                   ...
                   <div className='flex items-center w-full lg:w-11/12  flex-col' > 
                        ...
                        <div className='flex flex-col px-10  items-center'>
                         ...
                         {/* <button className=' font-bold text-green-700 mt-6'>Sta</button>  */}
                   </div>
