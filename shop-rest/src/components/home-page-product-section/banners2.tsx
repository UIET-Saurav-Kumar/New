  ...
  function location(){
    ...
    return (
        ...
        <div className='mx-1'>
            ...
            {location() &&  <Link href='https://buylowcal.com/shops?text=Night+Life&text_type=Category&avail='>
              <div className="px-1 ">
                     ...
                     className="rounded-lg  "
                        ...
                        /> */}
                        <img src='/01.webp' className="object-contain px-1 rounded-lg cursor-pointer" />
                </div>
            </Link>
           }
          ...
          {location() && <Link href='/salon-near-me'>
            <div className=" px-1">
             ...
             className="rounded-lg  "
                  ...
                  src={'/barista.jpg'} 
                  /> */}
                  <img src='/02.webp' className='object-contain px-1 rounded-lg cursor-pointer ' />
