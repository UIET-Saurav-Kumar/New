...
<div className='flex items-start h-full  align-center space-x-4 justify-evenly'>
            ...
            <div className='relative rounded-full px-2  bg-red-400 w-16 h-16 '>
            ...
            <div className='text-xl  font-light w-auto md:w-36 xl:w-40 2xl:w-48 text-gray-500'>
                {/* <div className='flex text-left flex-col'> */}
                    <h4 className='font-semibold text-lg md:text-sm  2xl:text-xl text-gray-800 '>
                          Total Earning
                    </h4>
                ...
                <div className='flex flex-col h-28 space-y-1'>
                  ...
                  <button onClick={getLink} className=' left-12 lg:left-6 xl:left-12 bottom-2 absolute bg-gradient-to-r from-green-500 to-yellow-500 px-3 
