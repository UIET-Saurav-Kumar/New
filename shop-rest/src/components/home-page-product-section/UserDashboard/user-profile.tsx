...
export default function UserProfile({data,isAuthorize}:any) {
  ...
  return (
        ...
        <div className='flex flex-col rounded-xl py-9 shadow-3xl w-full  bg-gradient-to-r from-red-50   to-blue-50 drop-shadow-2xl p-3'>
        
            {/* <div className=''> */}
            <div className='flex space-x-3 items-center border-b pb-3 '>
                {/* <span className='rounded-full w-10 h-10 border bg-red-400'></span> */}
                <div className=''>
                    <h3 className='text-gray-600 text-xl font-light'>Hey, <span className='text-gray-800 font-semibold'>{data ? data?.name.split(' ')[0] : 'Guest'}</span></h3>
