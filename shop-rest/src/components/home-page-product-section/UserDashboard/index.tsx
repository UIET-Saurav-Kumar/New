...
export default function UserDashboard() {
  ...
  return (
        ...
        <div className='grid grid-cols-1 lg:flex items-center w-full mt-0  lg:py-3
            ...
            <div className='grid grid-cols-2  border-b lg:border-b-0  place-content-center mt-1 sm:grid-cols-2 lg:grid-cols-3 grid-rows-2   gap-2 lg:gap-3 h-full p-2  lg:w-full'>
