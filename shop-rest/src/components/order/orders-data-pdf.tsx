...
export default function OrderDataPdf({
  order,
  subtotal,
  total,
  // discount,
          ...
          <View style={{ width: "100%" }} wrap={false}>
            ...
            <View style={styles.totalCountWrapper}>
              <View style={styles.totalCountRow}>
                ...
                <Text style={styles.totalCountCell}>{subtotal + '.00'}</Text>
              </View>
              {/* <View style={styles.totalCountRow}>
                <Text style={styles.totalCountCell}>Discount</Text>
                <Text style={styles.totalCountCell}>{discount+ '.00'}</Text>
              </View> */}
              {/* <View style={styles.totalCountRow}>
                <Text style={styles.totalCountCell}>Tax</Text>
                <Text style={styles.totalCountCell}>{sales_tax+ '.00'}</Text>
              </View> */}
              {/* <View style={styles.totalCountRow}>
                <Text style={styles.totalCountCell}>Delivery Fee</Text>
                <Text style={styles.totalCountCell}>{delivery_fee+ '.00'}</Text>
              </View> */}
              <View style={styles.totalCountRow}>
                <Text style={[styles.totalCell, { fontSize: 13 }]}>
                  Total
                </Text>
                <Text style={[styles.totalCell, { fontSize: 12 }]}>
                  {total+ '.00'}
                </Text>
              </View>
            </View>
