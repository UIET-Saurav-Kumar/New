			...
			// objectFit: 'fill',
			  ...
			  <div className='footer-top-section 
				  ...
				  <div className='footer-section-links  space-y-4 text-left'>
						...
						<a className='light-text cursor-pointer text-sm md:text-md lg:text-md xl:text-xl hover:underline font-light' href='/events'><h5  className='light-text mt-4 font-light'> Events</h5></a>
						</div> 
			  	 </div>
