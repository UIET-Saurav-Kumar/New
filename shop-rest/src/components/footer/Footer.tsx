			  ...
			  <div className='footer-top-section 
			  	...
			  	<div className='footer-section-links ml-6 lg:ml-0 space-y-4 mt- text-left'>
					  ...
					  <div className=' tracking-widest space-y-4'>
						...
						<Link href='./terms'><h5 className='phone-number cursor-pointer text-sm md:text-xl hover:underline text-primary font-normal -mt-'> Terms of Service</h5></Link>



						<Link href='./return-policy'><h5 className=' cursor-pointer text-sm md:text-xl hover:underline phone-number text-primary font-normal -mt-'> Refunds/Cancellations/Shipping</h5></Link> 
						<Link href='./privacy'><h5 className=' cursor-pointer text-sm md:text-xl hover:underline phone-number text-primary font-normal -mt-'>Privacy Policy</h5></Link> 
						<Link href='./contact'><h5 className=' cursor-pointer text-sm md:text-xl hover:underline phone-number text-primary font-normal -mt-'>Contact Us</h5></Link> 
				  ...
				  <div className='footer-section-links  space-y-4 text-left'>
					...
					<div className=' space-y-0 tracking-widest'> 
					  <a className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light mt-' href='./home#all-categories'><h5 className='light-text mt-4 font-light'>Categories</h5></a>
					  <a className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light mt-' href='./home#featured-shops'><h5 className='light-text mt-4 font-light'> Local Shops</h5></a>
			  	      <a className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light mt-' href='./home#ecommerce-store'><h5 className='light-text mt-4 font-light'> E-Stores</h5></a>	
					  <a className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light mt-' href='./home#offer-of-the-day'><h5  className='light-text mt-4 font-light'> Offer of the Day</h5></a>
					  <a className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light ' href='./home#featured-products'><h5  className='light-text mt-4 font-light'> Featured Products</h5></a>
			  		</div> 
			  	</div>
				  ...
				  <div className='footer-section-links  space-y-4 text-left'>
						...
						<div className=' space-y-4 tracking-widest '>
							<Link href='https://admin.buylowcal.com/register'>
								<h5 className='light-text cursor-pointer text-sm md:text-xl hover:underline  font-light'>Register as Vendor </h5>
							</Link>
							<h5 onClick={handleJoin} className='light-text cursor-pointer text-sm md:text-xl hover:underline font-light'>
					...
					<div className='flex flex-col  space-y-4'>
						...
						<div className='grid grid-cols-4 xs++:grid-cols-4 md:grid-cols-2 lg:flex -ml-3  justify-between w-60 place-items-center items-center  lg:gap-0 md:w-56 cursor-pointer text-3xl lg:text-xl'>
