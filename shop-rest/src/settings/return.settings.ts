    ...
    content: [
      {
        id: "1",
        title: "Return Policy",
        description: `Our policy lasts 7 days. If 7 days have gone by since your purchase, unfortunately we can’t offer you a refund or exchange.

        To be eligible for a return, your item must be unused and in the same condition that you received it. It must also be in the original packaging.
        
        Several types of goods are exempt from being returned. Perishable goods such as food, flowers, newspapers or magazines cannot be returned. We also do not accept products that are intimate or sanitary goods, hazardous materials, or flammable liqOur policy lasts 7 days. If 7 days have gone by since your purchase, unfortunately we can’t offer you a refund or exchange.
      ...
      },
      {
        ...
        If you’ve done all of this and you still have not received your refund yet, please contact us at gaurav@buylowcal.com . Sale items (if applicable)
      ...
      },
      {
        ...
        description: `
        We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at gaurav@buylowcal.com and send your item to: Plot No. 130, Phase 1, Industrial Area, Chandigarh, CH, 160002, India.
        ...
        To return your product, you should mail your product to: Plot No. 130, Phase 1, Industrial Area, Chandigarh, CH, 160002, India.
